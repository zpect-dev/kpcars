...
it('Cierres de Caja: filtran por empresa activa', function () {
    $admin = User::factory()->create([
        'role' => UserRole::ADMINISTRADOR,
        'dni' => '20000099',
    ]);
    ...
    session(['active_company_id' => $this->empresaA->id]);
    expect(\App\Models\CierreCaja::count())->toBe(1);

    // withoutGlobalScope expone ambos.
    expect(\App\Models\CierreCaja::withoutGlobalScope(TenantScope::class)->count())->toBe(2);
});
